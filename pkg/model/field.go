...
// IsRestorableReference returns true if the Field is a reference whose value
// must be restored after the set_resource readback reconstructs its parent
// container. Only references nested inside structs qualify:
//
