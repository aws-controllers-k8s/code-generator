{{- define "sub_resource_manager_singleton" -}}
...
{{ ParentPrimaryKeyAssign .CRD (ParentKind .CRD) "seed.ko" }}
	...
	if err != nil {
		if err == ackerr.NotFound {
			parent.{{ SubResFieldPath .CRD }} = nil
			return nil
		}
		return err
	}
	...
	parent.{{ SubResFieldPath .CRD }} = &found.ko.Spec
	return nil
}
...
func convertFromParent(parent *svcapitypes.{{ ParentKind .CRD }}) []resource {
	...
	if parent.{{ SubResFieldPath .CRD }} != nil {
		ko.Spec = *parent.{{ SubResFieldPath .CRD }}
	}
